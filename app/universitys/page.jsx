  ...
  return (
    <>
      <div className="flex">
        <Image
          src={cover}
          className=" max-sm:h-[60vh] max-sm:min-w-[80rem] max-sm:mt-16 max-lg:h-[60vh] max-lg:min-w-[80rem] max-lg:mt-16"
          alt="cover"
        />
      </div>
      <div>
        ...
        <div className="flex flex-wrap cursor-pointer max-sm:w-[70rem] max-lg:w-[80rem] max-lg:gap-10 max-sm:text-xl max-sm:gap-24 max-sm:justify-center">
          <a
            href="./altnbash"
            className="flex bg-[#fff] w-80 h-[25rem] max-sm:h-[27rem] rounded-lg shadow-sm mb-10 ml-4 mr-10 "
          ...
          >
            ...
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 absolute font-semibold text-2xl max-sm:text-xl max-lg:text-xl max-lg:mr-5  max-sm:w[30rem]">
            ...
            <strong className="text-gray-700 mt-[22.8rem]  mr-7 absolute font-semibold text-2xl">
              ...
              <h5 className="-mt-[1.6rem] max-sm:mt-6 max-sm:w-56 mr-8 text-xl">
                اسطنبول، تركيا
              </h5>
            </strong>
          </a>
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-1 absolute font-semibold text-2xl max-sm:text-xl max-lg:text-xl max-lg:mr-5  max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 absolute font-semibold max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem] text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
              جامعةأتيليم - Atilim
            </h2>
            <p className="text-gray-800 mt-[17rem] w-72 mr-7 absolute ">
              {" "}
            ...
            <strong className="text-gray-700 mt-[22.8rem] max-lg:w-[16rem]  mr-7 absolute font-semibold text-2xl">
              <svg
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 absolute font-semibold max-lg:text-xl max-lg:mr-5  text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 max-lg:text-xl max-lg:mr-5  absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
              جامعة بيكنت - Beykent
            </h2>
            <p className="text-gray-800 mt-[17rem] w-72 mr-7 absolute ">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem] absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
              جامعة بيكوز - Beykoz
            </h2>
            <p className="text-gray-800 mt-[17rem] w-72 mr-7 absolute ">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-1 absolute max-lg:text-xl max-lg:mr-5  font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-2 absolute max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]  font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 absolute max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]   font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
              جامعة إيشيك - Işık
            </h2>
            <p className="text-gray-800 mt-[17rem] w-72 mr-7 absolute ">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-2 max-lg:text-xl max-lg:mr-5 max-lg:w-[19rem]   absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-2 max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]   absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] max-lg:text-xl max-lg:mr-5 max-lg:w-[19rem]   mr-1 absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]   mr-4 absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <strong className="text-gray-700 mt-[22.8rem]  mr-7 absolute font-semibold text-2xl max-sm:text-xl max-sm:w[30rem]">
              <svg
                className="size-5 max-sm:mt-7 max-sm:absolute"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 384 512"
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] max-lg:text-xl max-lg:mr-5 max-lg:w-[19rem]   mr-2 absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
            ...
            <strong className="text-gray-700 mt-[22.8rem] max-lg:w-[23rem] mr-7 absolute font-semibold text-2xl ">
              <svg
                className="size-5 max-sm:mt-7 max-sm:absolute"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 384 512"
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]   mr-2 absolute font-semibold text-2xl max-sm:text-xl max-sm:w-full max-sm:mr-5">
          ...
          >
            ...
            <strong className="text-gray-700 mt-[22.8rem]  mr-7 absolute font-semibold text-2xl">
              ...
              <h5 className="-mt-[1.6rem] max-sm:mt-6 max-sm:w-56 mr-8 text-xl max-sm:text-xl max-sm:w[30rem]">
                اسطنبول، تركيا
              </h5>
            </strong>
          </a>
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]   mr-7 absolute font-semibold text-2xl max-sm:text-xl max-sm:w[30rem]">
              جامعة جيليشيم - Gelisim
            </h2>
            <p className="text-gray-800 mt-[17rem] w-72 mr-7 absolute ">
              تهدف جامعة جيليشيم الي انت تكون زاحده من اهم الجامعات العالميه
              التي تضيف قيمة الي المجتمع...
              <button className="rounded-md bg-[#ecbb5b] hover:bg-amber-300 px-2 py-1 text-sm font-medium text-white shadow">
                المزيد
              </button>
            </p>
          ...
          >
            ...
            <strong className="text-gray-700 mt-[22.8rem]  mr-7 absolute font-semibold text-2xl">
              ...
              <h5 className="-mt-[1.6rem] max-sm:mt-6 max-lg:w-[16rem]  max-sm:w-56 mr-8 text-xl">
                انقره، تركيا
              </h5>
            </strong>
          </a>
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-7 absolute max-sm:w-[30rem] max-lg:text-xl max-lg:mr-5 max-lg:w-[16rem]  font-semibold text-2xl max-sm:text-xl max-sm:w[30rem]">
              جامعة اوستيم - Ostim
            </h2>
            <p className="text-gray-800 mt-[17rem] w-72 mr-7 absolute ">
          ...
          >
            ...
            <Image
              ...
              className="w-12 h-12 rounded-full mr-[8.2rem] mt-44 absolute"
            />
            <h2 className="text-red-700 mt-[14.5rem] mr-2 absolute font-semibold text-2xl max-sm:text-xl max-sm:mr-5 max-sm:w-full">
